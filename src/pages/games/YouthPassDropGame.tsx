...
export default function YouthPassDropGame() {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="theme-game-screen youthpass-screen pb-10 max-w-5xl mx-auto">
      ...
      <section className="youthpass-game-grid grid min-w-0 grid-cols-1 items-start gap-4">
        <div className="youthpass-playfield-shell arcade-border-pink glass-panel-pink min-w-0 rounded-xl p-3 md:p-4">
          <div className="youthpass-playfield youthpass-playfield-size relative mx-auto w-full max-w-[390px] overflow-hidden rounded-[1.6rem] border-4 border-cyan-400/50 bg-[radial-gradient(circle_at_top,rgba(34,211,238,.20),transparent_34%),linear-gradient(180deg,#05111f,#16051a_70%,#050507)] shadow-[0_0_28px_rgba(0,242,255,.24)]">
        ...
        <aside className="youthpass-sidebar min-w-0 space-y-4">
