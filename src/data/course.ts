...
export const gameCatalog = [
  {
    ...
    inspiration: 'Pac-Man style chase games, Erasmus+ training life, Italian castle venues, and time-pressure arcade design',
    mechanic: 'Escape clock enemies through a clean castle maze and reach the Activity Room before Emanuel starts.',
    learningGoal: 'Feel how clear goals, enemies, readable maps, time pressure, and feedback make a simple game exciting.',
    takeaway: 'Clear goals, time pressure, readable feedback, and progressive levels can teach through play.',
    prototypePrompt: 'Clear goal + enemy pressure + feedback = stronger player motivation.',
    duration: '5-10 min',
    difficulty: 'Starter',
    color: 'text-pink-500',
  ...
  },
  {
    ...
    mechanic: 'Move left and right to catch healthy resources, avoid risky drops, and survive until YouthPass time.',
    learningGoal: 'Feel how meters, tradeoffs, and feedback can teach healthy choices through play.',
    takeaway: 'A clear resource system can teach healthy choices without becoming a lecture.',
  ...
  },
  {
    ...
    mechanic: 'Play through a dramatic story scene by scene, using choices that change meters, hidden flags, and endings.',
